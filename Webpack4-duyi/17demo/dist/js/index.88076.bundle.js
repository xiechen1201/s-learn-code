...
eval("// 希望导入的模块结果是一个可用的资源路径\nconst path = __webpack_require__(/*! ./assets/template.jpeg */ \"./src/assets/template.jpeg\");\n\nconsole.log(path)\n\n// if (Math.random() < 0.5) {\n    let img = document.createElement(\"img\");\n    img.src = path.default;\n    document.body.appendChild(img);\n// }\n\n\n//# sourceURL=webpack:///./src/index.js?");
